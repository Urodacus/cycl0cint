...
The purpose of this library is to make the verification functionality that is critical to cycl0cint's consensus available to other applications, e.g. to language bindings.
...
- [Ncycl0cint](https://github.com/NicolasDorier/Ncycl0cint/blob/master/Ncycl0cint/Script.cs#L814) (.NET Bindings)
