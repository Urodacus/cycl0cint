...
This document provides guidelines for internationalization of the cycl0cint Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to cycl0cint network</source>
        <translation>
            <numerusform>%n active connection to cycl0cint network</numerusform>
            <numerusform>%n active connections to cycl0cint network</numerusform>
        </translation>
    </message>
