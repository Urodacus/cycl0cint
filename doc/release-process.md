...
### cycl0cint maintainers/release engineers, suggestion for writing release notes
...
### Build and sign cycl0cint Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the cycl0cint.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the cycl0cint.org release
...
- Announce the release:
  ...
  - cycl0cint Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - bitcoincore.org blog post

  - Update title of #bitcoin on Freenode IRC

  - Optionally twitter, reddit /r/cycl0cint, ... but this will usually sort out itself
